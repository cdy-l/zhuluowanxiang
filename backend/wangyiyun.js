...
// 第一个参数
// args = '{"ids":"[1463165983]","level":"standard","encodeType":"aac","csrf_token":"76ae6d9119bec2746e07ac368e995601"}'
...
// 调用d函数来计算出目标数据，并输出目标数据
// console.log(d(args, e, f, g))

// var bVi3x = d(args, e, f, g);
// data = {
