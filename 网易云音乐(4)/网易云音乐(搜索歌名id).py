...
# # 从键盘输入歌曲的名称
song_name = input('请输入歌曲的名称:')

# # 从键盘输入歌曲的ID
song_id = input('请输入歌曲的ID:(在地址栏里)')
...
# 定义响应音乐数据包的链接
url = 'https://music.163.com/weapi/song/enhance/player/url/v1?csrf_token=76ae6d9119bec2746e07ac368e995601'
...
# 筛选数据歌曲下载
music_url = jsonpath(json_data, '$..url')[0]
# print(music_url)
